...
}:
{
  ...
  networking.wg-quick.interfaces.wg-dsekt = {
    ...
    listenPort = 51800;
    privateKeyFile = config.age.secrets.wireguard-zeus-private-key.path;
  ...
  age.secrets.wireguard-zeus-private-key.file = secretsDir + "/wireguard-zeus-private-key.age";
