  ...
  services.traefik = {
    ...
    staticConfigOptions = {
      ...
      entryPoints.httpredirect = {
        ...
        address = "${config.networking.hostName}.${workspace.baseDomain}:80";
    ...
    dynamicConfigOptions = {
      http = {
        routers.api-external = {
          rule = "Host(`traefik.${workspace.baseDomain}`)";
          service = "api@internal";
          middlewares = [ "auth" ];
          tls.certresolver = "default";
        };
        routers.nomad = {
          rule = "Host(`nomad.${workspace.baseDomain}`)";
          service = "nomad";
          tls.certresolver = "default";
        };
      ...
      tls.stores.default.defaultGeneratedCert = {
        resolver = "default";
        domain = {
          main = "${workspace.baseDomain}";
          sans = [ "*.${workspace.baseDomain}" ];
        };
      };
    };
  };
